...
function mailsend($txt='', $header='' , $mail='pwjrss@gmail.com'){

        $naglowki = "From: Wiadomość ze strony OkiDoki <strona@okidoki.tychy.pl>".PHP_EOL;
        ...
        return mail($mail, $header, $wiadomosc, $naglowki, 'strona@okidoki.tychy.pl');
	...
	if(!validateTypes('txt', $topic)){
		$errors['topic'] = 'Prosze podać tytuł emaila';
	}
	...
	if(count($errors)>0){
		...
		mailsend($txt, $topic, 'tychy@earlystage.slask.pl');
	}
